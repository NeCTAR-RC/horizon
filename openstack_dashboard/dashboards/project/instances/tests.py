...
class InstanceAjaxTests(test.TestCase):
    ...
    def test_row_update_instance_error(self):
        ...
        """(Pdb) messages
        [[u'error', u'Failed to launch instance "server_1": There is not enough capacity for this flavor in the selected availability zone. Try again later or select a different availability zone.', u'']]
        """
